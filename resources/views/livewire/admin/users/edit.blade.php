            ...
            <div class="modal-content">
                    ...
                    <form>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" accept=".png, .jpg, .jpeg, .gif" class="form-control"
                                id="profile_image" wire:model="profile_image" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" wire:model.lazy="role" required>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" wire:click="update()">
                        <div wire:loading><svg class="loading"></svg></div>&nbsp;Update
                    </button>
