                            ...
                            <div style="position: relative;">
                                <div class="image-container">
                                    @if (Storage::exists($favorite->product->product_image))
                                        <img class="card-img-top"
                                            src="{{ Storage::url($favorite->product->product_image) }}"
                                ...
                                <div class="pt-2 pr-2" style="position: absolute; top:0; right: 0;">
                                    @if ($favorite->product->product_stock >= 20)
                                        <span
                                            class="badge badge-success badge-pill">{{ number_format($favorite->product->product_stock) }}</span>
                                    @elseif ($favorite->product->product_stock)
                                        <span
                                            class="badge badge-warning badge-pill">{{ number_format($favorite->product->product_stock) }}</span>
                                    @else
                            ...
                            <div class="card-footer text-center mb-3 mt-auto">
                                ...
                                <div class="d-block font-size-1 mb-2">
                                    <span class="font-weight-medium"><i
                                            class="fas fa-peso-sign"></i>{{ number_format($favorite->product->product_price, 2, '.', ',') }}</span>
                                </div>
                                <div class="d-block font-size-1 mb-2">
                                ...
                                @role('user')
                                    ...
                                    @else
                                        ...
                                        <a class="btn btn-primary mt-1 form-control btn-block" data-toggle="modal"
                                            ...
                                            wire:click.prevent="toBuyNow({{ $favorite->product->id }})"><i
