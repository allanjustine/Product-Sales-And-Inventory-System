<div>
    ...
    <div class="container mt-3">
                        ...
                        <div class="grid-item col-md-3 col-sm-4 col-6">
                            <div class="card shadow product show" id="product-card" style="min-width: 50px;">
                                ...
                                <div class="card-footer text-center py-4 mt-auto">
                                    ...
                                    <a href="" class="btn btn-outline-info mt-1 form-control"
        ...
        <h4 class="text-center mt-4"><span class="location-text pb-2"><i
                    class="fa-solid fa-location-dot fa-shake fa-xl" style="color: #ad0000;"></i> AJM Restaurant is
        ...
        <div class="container d-flex justify-content-center mt-5 mb-3">
            <iframe class="elevation-3 rounded"
                ...
                width="700" height="350" frameborder="0" style="border:0;" allowfullscreen=""
